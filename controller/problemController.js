...
export const submitCode = async (req, res) => {
  try {
    ...
    console.debug("[submitCode] incoming body", req.body);
    ...
    if (!finalLanguageId) {
      ...
      if (heroines.length > 0) {
        const heroineLang = (heroines[0].language || "")
          .toString()
          .toLowerCase();
    ...
    console.error("[submitCode] unexpected error", err);
    throw err; // asyncHandler / errorHandler로 위임
  }
};
